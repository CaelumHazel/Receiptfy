...
const smoothieSteps = [
    { id: '1', description: 'Add banana, berries, and ice cube to a blender.' },
    { id: '2', description: 'Pour in almond milk and yogurt.' },
    { id: '3', description: 'Blend until smooth and creamy.' },
    { id: '4', description: 'Pour into a glass and enjoy!' },
];

const reviews = [
    { id: '1', name: 'Esme Kim', review: 'Amazing recipe, thank you!!', rating: 5, avatar: require('../assets/pp/CTRL.jpg') },
    { id: '2', name: 'Fergus Kim', review: 'Amazing recipe, thank you!!', rating: 5, avatar: require('../assets/pp/CreateNothin.jpg') },
    { id: '3', name: 'Misty Bloong', review: 'Amazing recipe, thank you!!', rating: 5, avatar: require('../assets/pp/belive.jpg') },
];

const screenWidth = Dimensions.get('window').width;

export default function FreshSmoothieScreen({ navigation }) {
    const recipe = {
        name: 'Fresh Smoothie',
        difficulty: 'Easy',
        rating: 4.7,
        reviews: 5,
        description: 'A refreshing blend of ripe fruits and almond milk, this smoothie is naturally sweet, packed with nutrients, and perfect for a light and healthy snack.',
        ingredients: [
            { id: '1', name: '1 banana', checked: false },
            { id: '2', name: '1 cup mixed berries', checked: false },
            { id: '3', name: '1 cup ice', checked: false },
            { id: '4', name: '1/2 cup almond milk', checked: false },
            { id: '5', name: '1/4 cup yogurt', checked: false },
        ],
        image: require('../assets/smoothie.jpg'),
        method: smoothieSteps,
    };
